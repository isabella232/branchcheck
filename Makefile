...
package: all
	...
	fpm -s dir -t deb -v $(VERSION) -n $(NAME) -a amd64  -m"INF ENG <dl-xoom-inf-eng@paypal.com>" --url https://github.com/xoom/branchcheck --iteration 1 --prefix /usr/local/bin -C packaging .
	fpm -s dir -t rpm --rpm-os linux -v $(VERSION) -n $(NAME) -a amd64  -m"INF ENG <dl-xoom-inf-eng@paypal.com>" --url https://github.com/xoom/branchcheck --iteration 1 --prefix /usr/local/bin -C packaging .
